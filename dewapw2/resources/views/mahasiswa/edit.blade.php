                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('mahasiswa.update', $mahasiswa->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tmpt_lahir" placeholder="Tempat Lahir" value="{{ old('tmpt_lahir') }}">
                            <label for="tgl_lahir">Tanggal Lahir</label>
                            <input type="date" class="form-control" name="tgl_lahir" placeholder="Tanggal Lahir" value="{{ old('tgl_lahir') }}">
                            ...
                            <select name="prodi_id" class="form-control">
                                ...
                                @foreach ($prodi as $item)
                                    <option value="{{ $item->id }}">{{ $item->nama }}
                                        @if (old("prodi_id", $mahasiswa->prodi_id) == $item['id']) selected @endif >
                                        {{ $item->nama }}
